...
sudo pacman -Suy
sudo pacman -S zsh git wget code tmux termite neovim chromium ttf-font-awesome xorg-server lightdm lightdm-gtk-greeter cinnamon adapta-gtk-theme containerd docker docker-compose libreoffice-fresh 
